...
export function Spill({ cls = '', icon: I, v, k, onClick }) { return <div className={`spill ${cls}`} onClick={onClick}><I size={20} className="ic2" /><div className="spill-meta"><div className="v">{v}</div><div className="k">{k}</div></div></div>; }
